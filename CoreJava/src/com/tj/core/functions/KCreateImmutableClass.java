...
public final class KCreateImmutableClass {
	...
	public KCreateImmutableClass(int i, String n, HashMap<String,String> hm){
	...
	public static void main(String[] args) {
		...
		KCreateImmutableClass ce = new KCreateImmutableClass(i, s, h1);
