...
public class KTestingReflection {
	...
	public static void main(String[] args) {
		...
		Class reflectClass = KUFOEnemyShip.class;
		...
		try {
			...
			constructor = reflectClass.getConstructor(new Class[] { KEnemyShipFactory.class });
		...
		KUFOEnemyShip newEnemyShip = null;

		KEnemyShipFactory shipFactory = null;

		try {

			// Create a UFOEnemyShip object by calling newInstance

			newEnemyShip = (KUFOEnemyShip) constructor.newInstance(shipFactory);
		...
		try {
			...
			KUFOEnemyShip enemyshipPrivate = new KUFOEnemyShip(shipFactory);

			// Define the private field you want to access
			// I can access any field with just its name dynamically

			privateStringName = KUFOEnemyShip.class.getDeclaredField("idcode");
			...
			Method privateMethod = KUFOEnemyShip.class.getDeclaredMethod(methodName, null);
			...
			privateMethod = KUFOEnemyShip.class.getDeclaredMethod("getOtherPrivate", methodParameters);
