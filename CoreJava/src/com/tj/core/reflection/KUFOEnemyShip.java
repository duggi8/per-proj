...
public class KUFOEnemyShip extends KEnemyShip {
	...
	public KUFOEnemyShip(int number, String randString) {
	...
	public KUFOEnemyShip(KEnemyShipFactory shipFactory) {
